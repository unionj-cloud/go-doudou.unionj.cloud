...
- 如果Go版本低于1.17
```shell
go get -v github.com/unionj-cloud/go-doudou/v2@v2.0.1
```
...
```shell
go get -v -d github.com/unionj-cloud/go-doudou/v2@v2.0.1
```
...
Latest release version is v2.0.1
✔ Yes
go install -v github.com/unionj-cloud/go-doudou/v2@v2.0.1
go: downloading github.com/unionj-cloud/go-doudou/v2 v2.0.1
