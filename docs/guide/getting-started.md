...
# show service 查看grpc server提供了哪些服务和rpc接口
...
# service HelloworldService 切换到HelloworldService服务下，
# 之后的call命令后面可以直接输入rpc名称了
helloworld.HelloworldService@127.0.0.1:50051> service HelloworldService

# call GreetingRpc 调用GreetingRpc接口，开启交互式终端，根据提示输入参数，输出返回值
